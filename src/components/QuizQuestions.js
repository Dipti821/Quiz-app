...
const QuizQuestions = () => {
  let myStyle = {
    background: "rgb(42, 168, 241,.75)",
    borderRadius: "30px",
    boxShadow: "0 0 20px 9px rgb(3, 24, 37)"
   }
                    ...
                    <FormControl fullWidth variant="outlined">
                      ...
                      >
                        {categories.map((category) => (
                          <MenuItem className="box" key={category.id} value={category.id}>
                            <span
                    ...
                    <FormControl fullWidth variant="outlined">
                      ...
                      >
                        {difficulties.map((difficulty) => (
                          <MenuItem className="box" key={difficulty.id} value={difficulty.id}>
                            {difficulty.name}
                          </MenuItem>
                        ))}
                      </Select>
